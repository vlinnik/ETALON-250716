...
class Drum(GearFQ):
    ...
    def __init__(self, t_5a: int|None = None,t_5b: int|None = None,t_5c: int|None = None, fq: int|None = None, fault: bool|None = None, q: bool|None = None, lock: bool|None = None,  id: str|None = None, parent: POU|None = None) -> None:
